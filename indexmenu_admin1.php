...
<header class="header">
    ...
    <nav class="navbar">
        <a href="bacatabel_member.php">DATA MEMBER</a>
         <a href="bacatabel_barang.php">DATA BARANG</a>
        <a href="bacatabel_transaksi.php">DATA TRANSAKSI</a>
       <a href="bacatabel_reviews.php">REVIEWS MEMBER</a>
    </nav>
    ...
    <form action="cekloginuser.php"method="post" class="login-form">
       <a href="indexadmin.php"> <h3>LOGOUT</h3></a>
    </form>
...
<section class="products" id="products">
  ...
  <div class="swiper-slide box">
        ...
        <tr>
          <h3> <a href="bacatabel_barang.php">Kelola Produk </a></h3></div></div>
        <tr>
...
<section class="review" id="review">
  ...
  <div class="swiper-slide box">
    ...
    <?php
        ...
        <div class="box">
            <a href="bacatabel_reviews.php" class="btn">Kelola Data Review</a>
